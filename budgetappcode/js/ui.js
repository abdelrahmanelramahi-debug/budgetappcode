...
function renderLedger() {
    ...
    const majorHtml = `
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <!-- General Savings -->
            <div class="premium-card p-5 bg-indigo-600 text-white border-indigo-500 shadow-lg shadow-indigo-100 flex flex-col justify-between relative overflow-hidden group">
                ...
                <button onclick="openSavingsBuckets()" class="w-full py-2 bg-white/35 hover:bg-white/45 text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition text-center backdrop-blur-sm shadow-sm ring-1 ring-white/30">
                    Manage
                </button>
            </div>

            <!-- Car Fund -->
            <div class="premium-card p-5 bg-slate-800 text-white border-slate-700 shadow-lg shadow-slate-200 flex flex-col justify-between relative overflow-hidden group">
                <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <button onclick="openTool('Car Fund')" class="w-full py-2 bg-white/20 hover:bg-white/30 text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition text-center backdrop-blur-sm shadow-sm ring-1 ring-white/20">
                    Manage
                </button>
            </div>

            <!-- Payables -->
            <div class="premium-card p-5 bg-amber-500 text-white border-amber-400 shadow-lg shadow-amber-100 flex flex-col justify-between relative overflow-hidden group">
                <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <button onclick="openTool('Payables')" class="w-full py-2 bg-white/35 hover:bg-white/45 text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition text-center backdrop-blur-sm shadow-sm ring-1 ring-white/30">
                    Manage
                </button>
            </div>
        </div>
